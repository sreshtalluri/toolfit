...
- create_task: 6/10 (60%), 95% CI [31%, 83%]
...
- create_reminder: notes wrong 1/10; notify_channels wrong 1/10
- create_task: title wrong 4/10
- list_tasks: status wrong 1/10
- update_task: title wrong 2/10

## Solvability Warnings
- create_task (seed 1, passed anyway, after 2 regeneration(s)): There are two identically-described tools, "create_task" and "update_task," both labeled "Add a new task," so it's unclear which one is meant to handle the request.
